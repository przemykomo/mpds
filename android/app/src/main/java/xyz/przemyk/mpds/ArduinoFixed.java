...
public class ArduinoFixed implements UsbSerialInterface.UsbReadCallback {
    ...
    private ArduinoFixed.UsbReceiver usbReceiver;
    ...
    public ArduinoFixed(Context context, int baudRate) {
        init(context, baudRate);
    }

    public ArduinoFixed(Context context) {
                            ...
                            if (hasId(device.getVendorId())) {
                                ...
                                if (serialPort != null) {
                                    if (serialPort.open()) {
                                        ...
                                        serialPort.read(ArduinoFixed.this);
